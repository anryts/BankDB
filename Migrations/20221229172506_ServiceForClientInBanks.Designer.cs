...
namespace BankDB.Migrations
{
    ...
    [Migration("20221229172506_ServiceForClientInBanks")]
    partial class ServiceForClientInBanks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BankDB.Models.ServiceForClientInBank", b =>
                {
                    ...
                    b.HasKey("ClientId", "ServiceInBankId")
                        .HasName("pk_service_for_client_in_banks");

                    b.HasIndex("ServiceInBankId")
                        .HasDatabaseName("ix_service_for_client_in_banks_service_in_bank_id");

                    b.ToTable("service_for_client_in_banks", (string)null);
                });
            ...
            modelBuilder.Entity("BankDB.Models.ServiceForClientInBank", b =>
                {
                    b.HasOne("BankDB.Models.Client", "Client")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_for_client_in_banks_clients_client_id");
                    ...
                    b.HasOne("BankDB.Models.ServiceInBank", "ServiceInBank")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_for_client_in_banks_service_in_bank_service_in_bank");
